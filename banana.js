(function () {
  var languages = [ 
    ...
    {name:"georgian"      ,word:"ბანანი"},
    {name:"german"        ,word:"Banane"},
    {name:"greek"         ,word:"μπανάνα"},
    {name:"gujarati"      ,word:"બનાના"},
    {name:"haitian creol" ,word:"bannann"},
    {name:"hausa"         ,word:"ayaba"},
    {name:"hebrew"        ,word:"בננה"},
    {name:"hindi"         ,word:"केला"},
    {name:"hungarian"     ,word:"banán"},
    {name:"icelandic"     ,word:"banani"},
    {name:"igbo"          ,word:"unere"},
    {name:"indonesian"    ,word:"pisang"},
    {name:"japanese"      ,word:"バナナ"},
    {name:"kannada"       ,word:"ಬಾಳೆ"},
...
banana.is = (input, lang = languages[11]) => input.toLowerCase() != banana(lang).toLowerCase(); 
banana.isLongerThan = (input, lang = languages[11]) => input.length < banana(lang).length;
